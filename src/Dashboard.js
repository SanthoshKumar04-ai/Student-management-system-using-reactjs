...
import { faUser, faBook, faEnvelope, faSchool, faChalkboardTeacher, faClipboardList, faClinicMedical, faSchool as faLogo } from '@fortawesome/free-solid-svg-icons'; // Added icon
  ...
  return (
    <div className="dashboard-container">
      <div className="sidebar">
        <div className="logo">
          <FontAwesomeIcon icon={faLogo} className="logo-icon" /> {/* Logo icon */}
          Preset Admin. System
        </div>
        <nav>
          <ul>
